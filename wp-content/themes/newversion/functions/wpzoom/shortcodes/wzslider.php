...
class wzslider {
    ...
    static public function init($atts, $content = null, $code = '') {
        ...
        if ($attachments) {       
            ...
            foreach ($attachments as $attachment) {
                $url =  ui::thumbIt(wp_get_attachment_url($attachment->ID, 'thumbnail', false, false), 'auto', $atts['height'], true); 
                $thumb =  ui::thumbIt(wp_get_attachment_url($attachment->ID, 'thumbnail', false, false), 'auto', 100, true); 
    ...
    static public function loadStatic() {
        wp_enqueue_script('galleria', wpzoom::$assetsPath . '/js/galleria.js', 'jquery', null, true); 
        wp_enqueue_script('wzslider', wpzoom::$assetsPath . '/js/wzslider.js', 'jquery', null, true);
 	}
