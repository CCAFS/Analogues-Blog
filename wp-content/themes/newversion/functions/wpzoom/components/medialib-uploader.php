...
class WPZOOM_Medialib_Uploader {
    ...
    public static function css() {
        $out = "";
        $out.= '<link rel="stylesheet" href="' . get_site_url() . '/' . WPINC . '/js/thickbox/thickbox.css" type="text/css" media="screen" />' . "\n";
        $out.= '<script type="text/javascript">
                var tb_pathToImage = "' . get_site_url() . '/' . WPINC . '/js/thickbox/loadingAnimation.gif";
                var tb_closeImage = "' . get_site_url() . '/' . WPINC . '/js/thickbox/tb-close.png";
                </script>' . "\n";
